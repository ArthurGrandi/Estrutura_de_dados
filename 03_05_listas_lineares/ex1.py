#Apresente os códigos em Python, para:
...
"""
Observando o comportamento das listas e as discussões até o momento, por que você
acredita que os arrays possuem melhor desempenho em relação as listas, isso
considerando Python?
"""
